		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">หน่วยงาน > ผู้จัดการข้อมูลแปลง - ${organization.name}</h4>
							<p align="right">
								<a href="${pageContext.request.contextPath}/organization/"
									class="btn mb-1 btn-light">กลับ</a>
								<a href="${pageContext.request.contextPath}/organization/fieldrole/edit/${organization.organizationId}"
									class="btn mb-1 btn-primary">เพิ่มผู้จัดการข้อมูลแปลง</a>
							</p>
								...
								<table
									...
									<c:forEach items="${staffs}" var="staff" >
										<tr>											
											...
											<td><a
												href="${pageContext.request.contextPath}/organization/staff/delete/${staff.staffId}"
												class="btn btn-danger" role="button"><i class="fa fa-trash" aria-hidden="true"></i></a>
											</td>
										</tr>
										</c:forEach>
									</tbody>

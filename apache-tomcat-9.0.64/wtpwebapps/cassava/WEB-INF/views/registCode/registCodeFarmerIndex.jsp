												...
												<h6 class="m-t-10 text-muted">
													หน่วยงาน : ${registcode.organization.name }<span
														...
														<a class="pull-right text-red"
															href="${pageContext.request.contextPath}/registcode/delete/${registcode.registerCodeId }"
						...
						$("#button")
							.click(
								function () {
									...
									$.ajax({
										url: "${pageContext.request.contextPath}/registfamercode/create",
										type: 'POST',
										data: formData,
										success: function (response) {
											window.location.href = "${pageContext.request.contextPath}/registcode/";
										},

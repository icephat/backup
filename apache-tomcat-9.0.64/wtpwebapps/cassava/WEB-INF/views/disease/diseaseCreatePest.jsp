		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">โรคมันสำปะหลัง > ${nameT.name} > แมลงพาหะและเชื้อสาเหตุ > เพิ่มแมลงพาหะ</h4>
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
									<c:forEach items="${Pestssum}" var="Pestssum">
									<c:if test="${not empty Pestssum.pestId}" >
          								...
          								<tr>
											...
											<td>${Pestssum.name}</td>
											<td>${Pestssum.scientificName}</td>
										<td><a
												href="${pageContext.request.contextPath}/disease/addpest/${Disease.diseaseId}/${Pestssum.pestId}" class="btn btn-primary" role="button"><i class="fa fa-plus" aria-hidden="true"></i></a></td>
										</tr>

												...
												<table class="table">
													...
													<c:forEach items="${Pests}" var="Pests">
														<tr>											
															...
															<td>
																<a href="${pageContext.request.contextPath}/disease/deletepest/${Disease.diseaseId}/${Pests.pestId}" class="btn btn-danger" role="button"><i class="fa fa-trash" aria-hidden="true"></i></a>
															</td>
														</tr>
													</c:forEach>
													</tbody>
													...
													<tbody>
														<c:forEach items="${Pathogens}" var="Pathogens">
															<tr>
																...
																<td>
																	<a href="${pageContext.request.contextPath}/disease/deletepathogen/${Disease.diseaseId}/${Pathogens.pathogenId}" class="btn btn-danger" role="button"><i class="fa fa-trash" aria-hidden="true"></i></a>
																</td>
															</tr>
														</c:forEach>
													</tbody>

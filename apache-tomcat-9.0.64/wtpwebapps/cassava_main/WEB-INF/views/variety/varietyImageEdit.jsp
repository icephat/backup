		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">พันธุ์มันสำปะหลัง > รายละเอียด > แก้ไขภาพ (${variety.name})</h4>
						<div class="row">
									...
									<div class="card">
										<div class="card-body">
											<div class="text-center">
												...
												<p class="text-muted">
												<h3>
													<a href="${pageContext.request.contextPath}/variety/varietyImageDelete/${img.imgVarietyId}"
						...
						<div class="form-validation">
							<form class="form-valide"
								action="${pageContext.request.contextPath }/variety/varietyImageSave"

				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<p align="right">
								<a href="varietyCreate/" class="btn mb-1 btn-primary">เพิ่มข้อมูล</a>
							</p>
							<div class="row">
										...
										<div class="card">
											<div class="card-body">
												<div class="text-center">
													...
													<p class="text-muted">${variety.trichome}</p>
													<p class="text-muted">
													<h3>
														<a href="${pageContext.request.contextPath}/variety/varietyEdit/${variety.varietyId}">
															<i class="fa fa-edit" aria-hidden="true"></i>
														</a> 
														<a href="${pageContext.request.contextPath}/variety/varietyDelete/${variety.varietyId}"

					...
					<div class="card">
						<div class="card-body">
							...
							<div class="form-validation">
								<form class="form-valide" id="varietyData"
									modelAttribute="variety" enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control"
												id="apicalLeavesColor" name="apicalLeavesColor"
												placeholder="">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="val-username">สีใบอ่อน<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
									...
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="val-username">สีก้านใบ<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="val-username"
									...
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="val-username">ลักษณะแฉกกลางใบ<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="val-username"
									...
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="branchingHabit">การแตกกิ่ง<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="branchingHabit"
												name="branchingHabit" placeholder="">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label"
											for="heightToFirstBranching">ความสูงของการแตกกิ่งแรก(ซม.)<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control"
												id="heightToFirstBranching" name="heightToFirstBranching"
												placeholder="">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										<label class="col-lg-4 col-form-label"
											for="starchContentRainySeason">เปอร์เซนต์แป้ง(ฤดูฝน)<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control"
												id="starchContentRainySeason"
												name="starchContentRainySeason" placeholder="">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label"
											for="starchContentDrySeason">เปอร์เซนต์แป้ง(ฤดูแล้ง)<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control"
												id="starchContentDrySeason" name="starchContentDrySeason"
												placeholder="">
										</div>
									</div>
									<div class="form-group row">
								...
								<form class="form-valide" id="image_data"
									...
									<div class="form-group row">
										<div class="col-lg-8 ml-auto">
											<a
												href="${pageContext.request.contextPath}/variety/varietyIndex"
												class="btn btn-light" role="button">กลับ</a>

											<button id="uploadBtn" class="btn btn-primary">Begin
												Upload</button>
...
uploadedArea = document.querySelector(".uploaded-area");
    ...
    //		   $('#myModal').modal('show');
    		   ...
    		   $.ajax({
   	            url: "${pageContext.request.contextPath }/variety/varietySave",
   	            type: 'POST',
   	            data: formData,
   	            success: function(response) {
   	            		...
   	            		if(files.length == 0){
   	            			window.location.href = "${pageContext.request.contextPath }/variety/varietyIndex";
   	            		}
   	            		//alert(files[0].name);
   	            		$('#myModal').modal('show');

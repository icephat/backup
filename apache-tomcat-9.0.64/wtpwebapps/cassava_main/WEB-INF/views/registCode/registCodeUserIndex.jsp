													...
													<form class="form-valide"
														...
														<div class="form-group">
															<c:forEach items="${organizations}" var="organization">
																<div class="col-lg-6">
																	<select name="organizationID" id="type"
																		class="form-control" required>
																		<option value="${organization.organizationId }">${organiztion.name}</option>
																	</select>
																</div>
															</c:forEach>
														</div>
						...
						<div class="card card-widget">
							<div class="card-body">
								...
								<div class="mt-4">
									<h6>
										ใช้แล้ว
										(${registcode.numUseRegist}/${registcode.numUseRegist})<span

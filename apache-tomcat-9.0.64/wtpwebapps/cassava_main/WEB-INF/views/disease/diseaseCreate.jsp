...
<title>DiseaseCreate Page</title>
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="form-validation">
								<form class="form-valide" action="${pageContext.request.contextPath }/disease/diseaseSave"
								method="post"  modelAttribute="targetofsurveyService"
								method="post">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="val-username"
												name="disease.imgdiseases" placeholder="">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-lg-8 ml-auto">
											<a href="${pageContext.request.contextPath }/disease/diseaseIndex"

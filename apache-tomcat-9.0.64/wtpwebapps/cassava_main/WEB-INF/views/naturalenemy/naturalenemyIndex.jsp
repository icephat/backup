				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<p align="right">
								<a
									href="${pageContext.request.contextPath }/naturalenemy/naturalenemyCreate"
										...
										<div class="card">
											<div class="card-body">
												<div class="text-center">
													...
													<h4 class="card-widget__title text-dark mt-3">${naturalenemy.commonName}</h4>
													<p class="text-muted">${naturalenemy.type}</p>
													<p class="text-muted">
													<h3>
														<a
															href="${pageContext.request.contextPath }/naturalenemy/naturalenemyEdit/${naturalenemy.naturalEnemyId}">
															<i class="fa fa-edit" aria-hidden="true"></i>
														</a> <a
															href="${pageContext.request.contextPath}/naturalenemy/naturalenemyDelete/${naturalenemy.naturalEnemyId}"

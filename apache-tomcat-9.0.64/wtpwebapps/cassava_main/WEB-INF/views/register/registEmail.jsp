					...
					<div class="form-input-content">
						<div class="card login-form mb-0">
							<div class="card-body pt-5">
								...
								<form class="mt-5 mb-5 login-input" action="${pageContext.request.contextPath}/register/registEmailSave"
									modelAttribute="user" method="post" >
									<div class="form-group">
										<input type="email" class="form-control" name="firstName" placeholder="อีเมล">
									</div>
									<div class="form-group">
										<input type="password" class="form-control" name="password" placeholder="รหัสผ่าน">
									</div>
									<button class="btn login-form__btn submit w-100">ถัดไป</button>
								</form>
							</div>
						</div>
					</div>

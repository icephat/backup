                ...
                <ul class="metismenu" id="menu">
                    <li>
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="${pageContext.request.contextPath }/registCode/registCodeFarmerIndex">รหัสลงทะเบียนเกษตรกร</a></li>
							<li><a href="{{ url('user/userIndex')}}">รหัสลงทะเบียนผู้ใช้ทั่วไป</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="${pageContext.request.contextPath }/variety/varietyIndex">พันธุ์มันสำปะหลัง</a></li>
							<li><a href="${pageContext.request.contextPath }/pathogen/pathogenIndex">เชื้อโรคพืช</a></li>

							<li><a href="${pageContext.request.contextPath }/disease/diseaseIndex">โรคมันสำปะหลัง</a></li>
							<li><a href="${pageContext.request.contextPath }/pest/pestIndex">ศัตรูพืช</a></li>
							<li><a href="${pageContext.request.contextPath }/naturalenemy/naturalenemyIndex">ศัตรูธรรมชาติ</a></li>
                        </ul>
                    </li>

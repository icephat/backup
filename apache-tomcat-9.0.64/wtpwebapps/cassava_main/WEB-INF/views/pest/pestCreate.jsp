					...
					<div class="card-body">
						...
						<div class="form-validation">
							<form class="form-valide"
								action="${pageContext.request.contextPath }/pest/pestSave"
								...
								<div class="form-group row">
									<label class="col-lg-4 col-form-label" for="val-username">แหล่งข้อมูล<span
										class="	source">*</span>
									</label>
									<div class="col-lg-6">
										<input type="text" class="form-control" id="val-username"
											name="pest.source" placeholder="">
									</div>
								</div>
								<div class="form-group row">

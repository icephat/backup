										...
										<div class="col-sm-12">
											<table
												...
												<tbody>
													...
													<tr th:each="reportComment : ${reportComments}">
														<td th:text="${reportComment.user.firstName}"></td>
														<td
															th:text="${reportComment.comment.activity.nameActivity}"></td>
														<td th:text="${reportComment.detail}"></td>

														<td><a
															th:href="@{./deletecomment(commentId=${reportComment.comment.commentId})}"

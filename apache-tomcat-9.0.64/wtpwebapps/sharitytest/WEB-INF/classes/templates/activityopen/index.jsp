...
<title>กิจกรรมที่คุณกำลังเปิด</title>
<!-- Favicon icon -->
					...
					<div class="col-12 m-b-30">
						...
						<div class="row">
							...
							<tr th:each="activity : ${activities}">
								...
								<div class="col-lg-9 col-xl-10" style="margin: auto;">
									<div class="card">
										<div class="card-header bg-white">
											<h5 class="card-title" th:text="${activity.nameActivity}"></h5>
											<h6 class="card-subtitle mb-2 text-muted"
												th:text="${activity.place}"></h6>
										</div>
										<div class="row" th:each="image : ${activity.imageActivities}">
											<img class="img-fluid"
												th:src="@{${'images/uploads/'+ image.imagePath}}"
												alt="First slide" width="500px" height="200px"
												style="margin: auto;">
										</div>
										<div class="card-body">
											<p class="card-text" th:text="${activity.detail}">
												รายละเอียด<br>
											</p>
										</div>
										<div class="card-footer" >
											<a th:href="@{./activitydetail(activityId=${activity.activityId})}"
													class="btn btn-outline-info float-right" style="height: 35px; margin: 5px;">
													<p>รายละเอียดกิจกรรม</p></a>
											<a th:href="@{./userinactivity(activityId=${activity.activityId})}"
												class="btn mb-1 btn-outline-info float-right" style="height: 35px; margin: 5px;"><p>รายชื่อผู้เข้าร่วมกิจกรรม</p></a> <a
												th:href="@{./request(activityId=${activity.activityId})}"
												class="btn mb-1 btn-outline-secondary float-right"
												style="height: 35px; margin: 5px;"><p>คำขอเข้าร่วมกิจกรรม</p></a>
												<a
												th:href="@{./deleteactiviy(activityId=${activity.activityId})}"
												class="btn mb-1 btn-outline-danger float-right"
												style="height: 35px; margin: 5px;"><p>ยกเลิกกิจกรรม</p></a>
										</div>
									</div>
								</div>
							</tr>

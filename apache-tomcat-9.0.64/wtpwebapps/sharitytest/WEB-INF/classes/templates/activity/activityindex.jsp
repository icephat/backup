			...
			<div class="row page-titles mx-0">
				<div class="col p-md-0">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="">กิจกรรมที่กำลังเปิด</a></li>
					</ol>
				</div>
			</div>
			<!-- row -->
								...
								<div class="row">
									...
									<div class="col-md-6 col-lg-3"
										...
										<div class="card">
											...
											<div class="card-body">
												<div class="row"
													th:each="image : ${activity.imageActivities}">
													<img class="img-fluid"
												...
												<p class="card-text" th:text="${'สถานที่จัดกิจกรรม : '+activity.place}"></p>
												<div class="row">
											...
											<div class="card-footer">
												<a
													th:href="@{./activitydetail(activityId=${activity.activityId})}"

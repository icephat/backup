									...
									<div class="card-body">
										...
										<div class="table-responsive">
											<table class="table table-striped">
												...
												<tbody>
													<tr th:each="joinActivitie : ${joinActivities}">
														<td th:text="${joinActivitie.activity.nameActivity}" />
														<td th:text="${joinActivitie.conditionActivity.conditionDetail}" />
														<td th:switch="${joinActivitie.status}"><span
															th:case="'apporve'">อนุมัติ</span> <span
															th:case="'reject'">ปฏิเสธ</span><span 
															th:case="'waiting'">รออนุมัติ</span></td>
														<td th:text="${joinActivitie.dateRequest}" /> 
														<td th:switch="${joinActivitie.status}"><span
															th:case="'waiting'"><a th:href="@{./deleteJoinActivity(joinActivityId=${joinActivitie.joinActivityId})}" class="btn btn-danger" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
